...
//		int array[] = {1,2,3,5,6,40,41,42,96,104,111};
		//isWin(array);
		//long currentTimeMillis2 = System.currentTimeMillis();
		//System.out.println(currentTimeMillis2-currentTimeMillis);
		
//		int array[] = {29, 35, 36, 40, 45, 68, 70, 89, 98,99, 102, 104, 108,109};
//		int array[] = {29,30,36,40,44,105,108,109};
//		showPai(array);
//		isWin(array);
		//计算要听的牌
		//能听的牌是  4万,8筒,1条,2条,3条,4条,5条   红中
		//结果是:	  4万,8筒	    3条,4条 ,5条   红中
		//        8筒         1条             3条 4条 5条      红中
		//           8筒   1条   2条 3  条  4条     5条    红中
		//4万 4万 1筒 2筒 3筒 7筒 9筒 1条 2条 3条 3条 红中 红中 
//		int tingpaiArray [] = {12,13,36,40,45,60,69,72,76,80,81,108,109};
		//2万 3万 3万 4万 4万 5万 8万 8万 1筒 2筒 3筒 6筒 6筒 6筒 
//		int tingpaiArray2 [] =   {4,10,11,12,13,16,30,31,36,40,44,56,57,58};
//		int tingpaiArray2 [] = {0,4,8,9,12,16,40};
//		showPai(tingpaiArray2);
//		List<Integer> resultList = getTingPaiList(tingpaiArray2);
//		showPai(resultList);
		int paiArray[] = {18,81,84,88,96,100,104,108};
		showPai(paiArray);
		isWin2(paiArray);
	}
	 ...
	 * @return
	 */
	public static List<Integer> getTingPaiList(int[] tingpaiArray) {
		List<Integer> resultList = new ArrayList<Integer>();
		for(int i=0;i<=108;i=i+4){
			int j = i;
			int binarySearch = MathUtil.binarySearch(j, tingpaiArray);
			if(binarySearch<0){
				int[] array = MathUtil.insertSortArray(tingpaiArray, j);
				boolean win = isWin2(array);
				if(win){
					resultList.add(i);
				}
			}else{
				j = j+1;
				while(MathUtil.binarySearch(j, tingpaiArray)>0){
					j = j +1;
				}
				int[] array = MathUtil.insertSortArray(tingpaiArray, j);
				boolean win = isWin2(array);
	...
	private static boolean otherCheck(int[] array) {
		...
		return checkWithDuiZiList(array, duiziList);
	}
	...
	private static boolean checkWithDuiZiList(int[] array,
		...
		if(duiziList.size()>0){
			for(int i=0;i<size/2;i++){
				...
				boolean isWin = check(array, dui1,dui2);
				if(isWin){
	...
	public static boolean check(int[] array,int num1,int num2) {
		int[] arr = getArrayWithoutDuiZi(array, num1, num2);//得到除对子以外的牌
	...
	private static List<Integer> getCardsWithoutCan(List<Integer> list) {
	 ...
	 * @return 
	 */
	private static List<Integer> getCardsWithoutSen(List<Integer> cards) {//233445  112233  2344456
		//showPai(cards);
...
//			boolean haveHongZhong = 
	...
	public boolean haveHongZhong(List<Integer> cards){
	...
	public static void showPai(List<Integer> cards){
	...
	public static boolean checkWinWithDuizi2(int[] array,int num1,int num2) {
		int[] arr = getArrayWithoutDuiZi(array, num1, num2);
	 ...
	 * @param arr
	 */
	private static List<Integer> getListWithoutHongZhong(int[] arr) {
	...
	public static int[] getArrayWithoutDuiZi(int[] array,int num1,int num2){
